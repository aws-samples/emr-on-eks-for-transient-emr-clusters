...
aws iam create-role --role-name realtime-batch-JobExecutionRole --assume-role-policy-document file://~/environment/emr-trust-policy.json --no-cli-pager
aws iam create-role --role-name intra-day-batch-JobExecutionRole --assume-role-policy-document file://~/environment/emr-trust-policy.json --no-cli-pager
aws iam create-role --role-name nightly-batch-JobExecutionRole --assume-role-policy-document file://~/environment/emr-trust-policy.json --no-cli-pager
aws iam create-role --role-name monthly-batch-JobExecutionRole --assume-role-policy-document file://~/environment/emr-trust-policy.json --no-cli-pager
aws iam create-role --role-name adhoc-ml-batch-JobExecutionRole --assume-role-policy-document file://~/environment/emr-trust-policy.json --no-cli-pager
