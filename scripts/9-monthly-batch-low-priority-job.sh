...
spark = SparkSession.builder.appName("monthly-batch-low-priority-job").getOrCreate()
...
--execution-role-arn "$(aws iam get-role --role-name monthly-batch-JobExecutionRole --query Role.Arn --output text)" \
